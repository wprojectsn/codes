...
class BeamSearch(object):
    def __init__(self, model_file_path):
        ...
        self.batcher = Batcher(config.decode_data_path, self.vocab, self.concept_vocab, mode='decode',
    ...
    def beam_search(self, batch):
        ...
        encoder_outputs, encoder_hidden, max_encoder_output, _, _ = self.model.encoder(enc_batch, enc_lens, enc_batch, enc_batch)
        ...
        while steps < config.max_dec_steps and len(results) < config.beam_size:
            ...
            final_dist, s_t, c_t, attn_dist, p_gen, coverage_t = self.model.decoder('decode', y_t_1, s_t_1,
                                                        encoder_outputs, enc_padding_mask, c_t_1,
                                                        extra_zeros, enc_batch_extend_vocab, enc_batch_concept_extend_vocab, concept_p, position, concept_mask, coverage_t_1, steps)
